...
zteText.Text = "ZEENN SCRIPTS" -- Changed text
...
-- Phase 3: Moon and "ZEENN SCRIPTS" move off-screen, background fades
...
-- "ZEENN SCRIPTS" goes right off-screen
...
discordText.Text = "https://discord.gg/tsernCAJ"
